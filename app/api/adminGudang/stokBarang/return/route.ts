...
import { returnStock, HttpError } from "@/app/features/stokBarang/services/stokBarangService";
...
export async function POST(req: Request) {
  try {
    ...
    await returnStock({ partNumber, plant, quantity }, user.username);
    return jsonOk({ done: true }, 201);
  } catch (e: any) {
