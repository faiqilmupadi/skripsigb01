...
import { adminRequestRestock } from "@/app/features/stokBarang/services/restockService";
...
export async function POST(req: Request) {
  try {
    ...
    const out = await adminRequestRestock({ partNumber, plant, quantity }, user.username);
